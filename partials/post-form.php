...
<form action="<?= BASE_URL ?>/controllers/create_post.php" method="POST" enctype="multipart/form-data" class="tweet-box p-4 d-flex flex-column">
  ...
  <div class="mt-1 d-flex justify-content-between align-items-center flex-wrap gap-2 pt-1 border-top border-secondary-subtle">
    <div class="d-flex gap-3 flex-wrap py-2">
      <!-- Bild Upload -->
      <label for="file-upload-image" class="btn btn-sm btn-outline-light rounded-pill transition-all py-2 px-3" tabindex="0" role="button" title="Bild hochladen">
      ...
      <!-- Video Upload -->
      <label for="file-upload-video" class="btn btn-sm btn-outline-light rounded-pill transition-all py-2 px-3" tabindex="0" role="button" title="Video hochladen">
      ...
      <div class="position-relative">
        <button
          type="button"
          id="emoji-picker-btn"
          class="btn btn-sm btn-outline-light rounded-pill transition-all py-2 px-3"
    ...
    <div id="post-btn-wrapper" class="d-flex gap-2 py-2">
      <button type="submit" id="create-post-btn" class="btn btn-primary rounded-pill px-4 py-2 transition-all">
    ...
    <div id="edit-btn-wrapper" class="d-none d-flex gap-3 py-2">
      <button type="submit" class="btn btn-primary rounded-pill px-4 py-2 transition-all">
        <i class="bi bi-check-lg me-2"></i><span class="d-none d-md-inline">Update</span>
      </button>
      <button type="button" id="cancel-edit" class="btn btn-outline-light rounded-pill py-2 px-3 transition-all">
